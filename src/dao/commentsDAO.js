  ...
  */
  ...
  static async addComment(movieId, user, comment, date) {
    try {
      ...
      console.log("addComment ---> ", commentDoc)

      const insertResponse = await comments.insertOne(commentDoc)

      console.log(
        "addComment insertResponse ---> ",
        insertResponse.insertedCount,
      )
  ...
  static async updateComment(commentId, userEmail, text, date) {
    try {
      ...
      console.log("updateComment ---> ", commentId, userEmail, text, date)

      console.log(
        "updateComment updateResponse ---> ",
        updateResponse.updatedCount,
      )
  ...
  static async deleteComment(commentId, userEmail) {
    ...
    */
    ...
    try {
      ...
      console.log("deleteComment ---> ", commentId, userEmail)
